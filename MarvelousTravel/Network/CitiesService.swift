...
class CitiesService {
    ...
    func citiesAutocompletionQuery(_ inputString: String, onSuccess: @escaping ([City])->(), onError: @escaping (Error?) -> ()) {
        // rework
        ...
        components.queryItems = [
            ...
            URLQueryItem(name: "fields", value: "id,name,score,country_id,parent_id,snippet"),
